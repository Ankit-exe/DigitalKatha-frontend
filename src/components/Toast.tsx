...
export const Toast = ({ message, success }: Props) => {

  return (
    <div
      id="toast-success"
      className="flex items-center p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 absolute top-0 right-0 mt-5 mr-5 px-5"
      role="alert"
    >
      <div
        className={
      ...
      <button
        ...
        aria-label="Close"
        onClick={() => {
          // Hide the toast if the close button is clicked
